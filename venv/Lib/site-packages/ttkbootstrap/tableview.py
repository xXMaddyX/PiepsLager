...
class Tableview(ttk.Frame):
    ...
    def save_data_to_csv(self, records, delimiter=","):
...
class TableCellRightClickMenu(tk.Menu):
    ...
    def __init__(self, master: Tableview):
        ...
        config = {
            "sortascending": {
                "label": f'''⬆  {MessageCatalog.translate("Sortiere Aufsteigend")}''',
                "command": self.sort_column_ascending,
            },
            "sortdescending": {
                "label": f'''⬇  {MessageCatalog.translate("Sortiere Absteigend")}''',
                "command": self.sort_column_descending,
            },
            "clearfilter": {
                "label": f'''{MessageCatalog.translate("⎌")} {MessageCatalog.translate("Filter zurücksetzen")}''',
                "command": self.master.reset_row_filters,
            },
            "filterbyvalue": {
                "label": f'''{MessageCatalog.translate("Filtern nach Zellenwert")}''',
                "command": self.filter_to_cell_value,
            },
            "hiderows": {
                "label": f'''{MessageCatalog.translate("Ausgewählte Zeile verbergen")}''',
                "command": self.hide_selected_rows,
            },
            "showrows": {
                "label": f'''{MessageCatalog.translate("Zeige nur ausgewählte Zeile")}''',
                "command": self.filter_to_selected_rows,
            },
            "exportall": {
                "label": f'''{MessageCatalog.translate("Export ganzer Datensatz")}''',
                "command": self.export_all_records,
            },
            "exportpage": {
                "label": f'''{MessageCatalog.translate("Export aktuelle Seite")}''',
                "command": self.export_current_page,
            },
            "exportselection": {
                "label": f'''{MessageCatalog.translate("Export ausgewählte Zeile")}''',
                "command": self.export_current_selection,
            },
            "exportfiltered": {
                "label": f'''{MessageCatalog.translate("Export alle gefilterten Objekte")}''',
                "command": self.export_records_in_filter,
            },
            "moveup": {
                "label": f'''↑ {MessageCatalog.translate("Verschieben Hoch")}''',
                "command": self.move_row_up
            },
            "movedown": {
                "label": f'''↓ {MessageCatalog.translate("Verschieben Runter")}''',
                "command": self.move_row_down,
            },
            "movetotop": {
                "label": f'''⤒ {MessageCatalog.translate("Verschieben nach ganz oben")}''',
                "command": self.move_row_to_top,
            },
            "movetobottom": {
                "label": f'''⤓ {MessageCatalog.translate("Verschieben nach ganz unten")}''',
                "command": self.move_row_to_bottom,
            },
            "alignleft": {
                "label": f'''◧  {MessageCatalog.translate("Links ausrichten")}''',
                "command": self.align_column_left,
            },
            "aligncenter": {
                "label": f'''◫  {MessageCatalog.translate("Mittig ausrichten")}''',
                "command": self.align_column_center,
            },
            "alignright": {
                "label": f'''◨  {MessageCatalog.translate("Rechts ausrichten")}''',
                "command": self.align_column_right,
            },
            "deleterows": {
                "label": f'''🞨  {MessageCatalog.translate("Lösche ausgewählte Zeile")}''',
        ...
        self.add_cascade(menu=sort_menu, label=f'''⇅  {MessageCatalog.translate("Sortieren")}''')
        ...
        self.add_cascade(menu=filter_menu, label=f'''⧨  {MessageCatalog.translate("Filtern")}''')
        ...
        self.add_cascade(menu=export_menu, label=f'''↔  {MessageCatalog.translate("Exportieren")}''')
        ...
        self.add_cascade(menu=move_menu, label=f'''⇵  {MessageCatalog.translate("Verschieben")}''')
        ...
        self.add_cascade(menu=align_menu, label=f'''↦  {MessageCatalog.translate("Ausrichten")}''')
